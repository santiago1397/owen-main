        ...
        for msg in fetched:
            ...
            try:
                ...
                if created and parsed.ok:
                    ...
                    # and surface as an error for something that is simply not a lead.
                    ignored += 1
                    logger.info("mail_poller: ignored non-job email (%s) subject=%r",
                                parsed.ignored_reason, msg.subject)
                elif created:
                    failed += 1
