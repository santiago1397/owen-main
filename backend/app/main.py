...
# The CRM's status dot (2026-09-14): GET /api/link-status, crm_link-scoped, READ-ONLY.
# Answers while the kill switches are off, because reporting them is its job.
app.include_router(link_status_api.router)
